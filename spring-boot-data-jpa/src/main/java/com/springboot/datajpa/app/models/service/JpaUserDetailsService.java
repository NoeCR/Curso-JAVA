...
import com.springboot.datajpa.app.models.dao.IUsuarioDao;
import com.springboot.datajpa.app.models.entity.Role;
...
public class JpaUserDetailsService implements UserDetailsService{
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if(usuario == null) {
			logger.error("No éxiste el usuario: " + username);
